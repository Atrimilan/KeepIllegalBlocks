 ...
 */
public class FragileClassifier extends AbstractClassifier<FragileType> {

    @Override
    protected FragileType classifyBlockData(BlockData blockData) {
    ...
    @Override
    protected FragileType classifyMaterial(Material material) {
        return switch (material) {
            ...
            case REDSTONE -> FragileType.REDSTONE_WIRE;
